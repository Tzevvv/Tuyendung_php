            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <a href="index.php" class="nav-item nav-link">ホーム</a>
                      <a href="about.php" class="nav-item nav-link active ">企業採用者向け</a>
        ...
        <div class="single">
            <div class="container">
                ...
                <div class="section-header text-center">
                    <i><h2>For recruiter - 採用企業様へ</h2></i>
                </div>

                </div>
                <div class="t1">
                              <p>弊社のホームページにお越しいただき、まことにありがとうございます。少子高齢化から人手不足である現在、外国人を採用することに取り組んでいかなければならないと分かりながらも、一抹の不安を感じている採用担当者様は多いのではないかと思います。弊社は、外国人と日本人によって経営されている会社であるため、そのような御社のご不安に適切に対応することができます。<br>弊社をご利用いただき、外国人材の採用に安心して取り組んでいただければ幸いです。</p>
                             <p>ご存知のこととは思いますが、外国人材を採用するに当たり、最も注意をしなければならないのが、「在留資格」です。<br>日本人の配偶者等、日本での仕事に限定のない在留資格もございますが、基本的に仕事をするために日本に来る外国人の場合は、それぞれの「在留資格」の範囲内でしか活動できません。また、希望する「在留資格」を得られるか否かは、その外国人のこれまでの学歴、経歴等がとても重要となります。その活動をする能力のない外国人にはその「在留資格」を与えるべきではないからです。</p>
                             <p>「在留資格」弊社は行政書士事務所と密接に提携しております<br>そのため、弊社は単に外国人労働者を紹介するということにとどまらず、御社が望む人材から、どのような在留資格を有する外国人が必要であるか否かの判断を提携行政書士が行い、その在留資格を有する、又は取得できる見込みのある外国人材を御社にご案内するということが可能です。</p>
                            <p>また、弊社は外国人を御社が採用する場合には、その外国人のサポートを御社に代わって行うことができます。もちろん、ご案内させていただいた外国人の生活サポート等については、できる限り、弊社がサポートさせていただきます。<br>さらには、採用した外国人の業務内容の変更等の可否についてまで、提携行政書士に相談できる体制を整えておりますので、採用時はもちろん、採用後まで、弊社は御社をサポートいたします。</p>
                            <p>外国人の採用でお尋ねされたいことがございましたら、まずはお問合せフォームからお問合せをお願いいたします。</p>
                              </div>
            </div>
