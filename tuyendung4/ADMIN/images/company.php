            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <a href="index.php" class="nav-item nav-link">ホーム</a>
                      ...
                      <a href="company.php" class="nav-item nav-link active">会社概要</a>
        ...
        <div class="single">
            <div class="container">
                ...
                <div class="col-lg-9"><div class="container">
                    <div class="t2" style ="margin-bottom: 50px">
                        <p>株式会社就職サポートのホームページにお越しいただき、ありがとうございます。弊社は、2021年10月13日に設立いたしました。今後、より一層優秀な外国人人材の育成に励み、日本での就労をサポートし、日本企業と日本に貢献していく所存です。外国人材を採用した日本企業の皆さまの笑顔と、御社で働く外国人人材の笑顔を見続け、弊社の企業理念を実現していきたいと思います。どうぞよろしくお願いいたします。</p>
                    </div>
                <div class="section-header text-center">
                    <i><h2>Company profile - 会社概要</h2></i>
                </div>
                ...
                <table  border="1"width = "100%" style="margin-top:10px">
                    <tbody>
                    <tr>
                    <td style="text-align: center"><strong>会社名</strong></td>
                    <td>株式会社就職サポート</td>
                    </tr>
                    <tr>
                    <td style="text-align: center;"><strong>代表者名</strong></td>
                    <td>チャン イック ヒェップ</td>
                    </tr>
                    <tr>
                    <td><strong style="text-align:center;">設立年月日</strong></td>
                    <td>2021年10月13日</td>
                    </tr>
                    <tr>
                    <td style="text-align: center;"><strong>所在地</strong></td>
                    <td>〒110-0005&nbsp; 東京都台東区上野5－7－7公徳堂ビル5階501室</td>
                    </tr>
                    <tr>
                    <td style="text-align: center;"><strong>連絡先</strong></td>
                    <td>Tel: 03-5604-9180  Fax: 03-5604-9181&nbsp; Email:</td>
                    </tr>
                    <tr>
                    <td style="text-align: center;"><strong>法人等番号</strong></td>
                    <td>0105－01－047967</td>
                    </tr>
                    <tr>
                    <td style="text-align: center;"><strong>企業略歴</strong></td>
                    <td>&nbsp;2021年10月13日 株式会社就職サポート設立</td>
                    </tr>
                    <tr>
