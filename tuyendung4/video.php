      ...
      <!-- Top Bar End -->
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <a href="index.php" class="nav-item nav-link">ホーム</a>
                      ...
                      <a href="video.php" class="nav-item nav-link active">Video</a>
        ...
        <div class="single">
            <div class="container">
                ...
                <?php
                $select_video=$get_data->select_video();
                foreach ($select_video as $se_vi) { ?>
                <div class="video" style="margin-bottom:40px;">
                    <video src="ADMIN\video\<?php echo $se_vi['DUONGDAN'];?>" controls></video>
                    <h3><?php echo $se_vi['TITLEVIDEO'];?></h3>
                    <!-- <p> <a href="ADMIN/images/pdf.pdf">link hướng dẫn 1</a></p> -->
                </div>
                <?php } ?>
