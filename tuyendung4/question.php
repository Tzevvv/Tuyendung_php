...
<html lang="en">
    <head>
        ...
        <!-- Template Stylesheet -->
        <link href="css/stylequestion.css" rel="stylesheet">
    </head>
      ...
      <!-- Top Bar End -->
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <a href="index.php" class="nav-item nav-link">ホーム</a>
                      ...
                      <a href="map.php" class="nav-item nav-link">会社概要</a>
                      ...
                      <a href="question.php" class="nav-item nav-link active">よくある質問</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="single">
            <div class="container">
                ...
                <div class="col-lg-9">
                    <div class="t3">
                        <h2>Frequently Asked Questions - よくあるご質問</h2>
                        <h3>どのように求人を依頼すればよろしいですか？</h3>
                        <p>A まずはお問合せフォームからお問い合わせください。契約期間、就業場所、業務内容等の基本的な労働条件を定められている場合、話をスムーズに進めることができますが、基本的な労働条件の定め方についてもご不明なことがあれば、そのご相談にも応じさせていただきます。</p>
                    </div>
                    <div class="t4">
                        <h3>どのような在留資格を持つ外国人を探せばよいのですか？</h3>
                    <p>A 外国人の在留資格には、その外国人の「活動」に基づくものと「身分又は地位」に基づくものの２種類があります。<br>
永住者、定住者、日本人の配偶者等の「身分又は地位」に基づく在留資格を持つ外国人の場合、活動には制限はありませんので、基本的にはどのような業務を行わせることも自由にできます。<br>これに対して、技術・人文知識・国際業務、技能、特定技能、技能実習等の「活動」に基づく在留資格を持つ外国人の場合、その活動をするために日本に在留することが認められているため、必然的にその者が行うことができる業務には制限があります。この制限に違反した場合、雇用する側にも不法就労を助長したということで罰則が適用されることがありますので、採用時、雇用中、細心の注意が必要です</p>
                    </div>
            </div>
